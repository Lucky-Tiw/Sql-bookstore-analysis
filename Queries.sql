...
--1) Show all the customers who ordered more than 1 quantity of books along with their country name. 
SELECT c.name, c.country, SUM(o.quantity) AS Ordered_quantity FROM Customers c
JOIN Orders o ON
